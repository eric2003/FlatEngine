...
Game::Game()
{
    ...
    QRectF boxRect( 10, 20, 100, 40 );
    QGraphicsRectItem * box = new QGraphicsRectItem( boxRect );
    QGraphicsRectItem * box1 = new QGraphicsRectItem( boxRect );

    box->setBrush( Qt::red );
    box->setPen(pen);
    this->scene->addItem(box);
    box1->setBrush( Qt::red );
    box1->setPen(pen);
    this->scene->addItem(box1);

    PrintBoxInfo(box);

    box->setRotation(box->rotation()+10);
    PrintBoxInfo(box);


    QRectF boxRect1( 200, 100, 100, 40 );
    QGraphicsRectItem * box2 = new QGraphicsRectItem( boxRect1 );
    QGraphicsRectItem * box3 = new QGraphicsRectItem( boxRect1 );
    QGraphicsRectItem * box4 = new QGraphicsRectItem( boxRect1 );

    box2->setBrush( Qt::red );
    box2->setPen(pen);
    this->scene->addItem(box2);

    box3->setBrush( Qt::red );
    box3->setPen(pen);
    this->scene->addItem(box3);

    box4->setBrush( Qt::red );
    box4->setPen(pen);
    this->scene->addItem(box4);

    PrintBoxInfo(box3);

    QPointF center = boxRect1.center();

    QTransform t;
    t.translate(center.x(), center.y());
    t.rotate(10);
    t.translate(-center.x(), -center.y());
    box2->setPos(t.map(box2->pos()));
    box2->setRotation(box2->rotation() + 10);
    t.reset();
    ...
    box4->setPos(t.map(box4->pos()));
    box4->setRotation(box4->rotation() + 90);
