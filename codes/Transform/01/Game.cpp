...
Game::Game()
{
    ...
    const int width = 50;
    const int height = 50;
    QRectF boxRect( 200, 0, 100, 50 );
    QRectF boxRect1( 0, 0, 100, 50 );
    ...
    QGraphicsRectItem * boxOld = new QGraphicsRectItem( boxRect1 );
    boxOld->setBrush(Qt::red);
    boxOld->setPen(pen);
    this->scene->addItem(boxOld);
